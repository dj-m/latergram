...
class ProfileController:UIViewController {
    ...
    var profileUsername = Profile.currentUser?.username //Shows current user by default
    var userProfile: Profile? // Get a user's profile if necessary
    ...
    override func viewDidLoad() {
        ...
        profilePic.layer.cornerRadius = 40 //Height & Width in storyboard is 80. 
        profilePic.layer.masksToBounds = true //Required for UIImageView to hide the clip portion
    ...
    @IBAction func logoutTapped(sender: UIBarButtonItem) {
        ...
        tabBarController?.dismissViewControllerAnimated(true, completion: nil) //Dismisses the centerTabBarController!
    }
}
